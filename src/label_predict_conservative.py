...
# ================= 配置区 =================
MODEL_PATH = (
    "E:/PycharmProjects/traffic-defect-detection/"
    "experiments/baseline_seed/weights/best.pt"
)

UNLABELED_IMG_DIR = Path(
    "E:/PycharmProjects/traffic-defect-detection/"
    "data/NEU-DET-semi/unlabeled/images/train"
)

PSEUDO_LABEL_DIR = Path(
    "E:/PycharmProjects/traffic-defect-detection/"
    "data/NEU-DET-semi/unlabeled/pseudo_labels-conservative/train"
)
