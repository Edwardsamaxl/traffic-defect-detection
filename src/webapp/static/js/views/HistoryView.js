...
export default {
  ...
  setup() {
    ...
    return { records, loading, total, page, filters, modelOptions, showModal, detailItem, totalPages, getColor, formatDate, debounceSearch, clearFilters, loadHistory, showDetail }
  }
}
